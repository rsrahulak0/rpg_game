...
class Person:
    def __init__(self, name, hp, mp, atk, df, magic, items, quit):
        self.maxhp = hp
        self.hp = hp
        self.maxmp = mp
        self.mp = mp
    ...
    def choose_endgame(self):
        i = 1

        print("\n" + bcolors.FAIL + bcolors.BOLD + "     QUIT GAME" + bcolors.ENDC)
        print("          " + str(i) + "." + " Press - 1 - to quit the game")
        print("          " + str(i+1) + "." + " Back to previous menu")
